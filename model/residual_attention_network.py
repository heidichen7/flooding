...
class ResidualAttentionModel_92_32input_update(nn.Module):
    ...
    def __init__(self):
        ...
        self.attention_module1 = AttentionModule_stage1_cifar(64, 64, size1=(224, 224), size2=(112, 112))  # 32*32
        self.residual_block2 = ResidualBlock(64, 128, 2)  # 16*16
        self.attention_module2 = AttentionModule_stage2_cifar(128, 128, size=(112, 112))  # 16*16
        self.attention_module2_2 = AttentionModule_stage2_cifar(128, 128, size=(112, 112))  # 16*16 # tbq add
        self.residual_block3 = ResidualBlock(128, 256, 2)  # 4*4
        self.attention_module3 = AttentionModule_stage3_cifar(256, 256)  # 8*8
        self.attention_module3_2 = AttentionModule_stage3_cifar(256, 256)  # 8*8 # tbq add
        self.attention_module3_3 = AttentionModule_stage3_cifar(256, 256)  # 8*8 # tbq add
        self.residual_block4 = ResidualBlock(256, 512)  # 8*8
        self.residual_block5 = ResidualBlock(512, 512)  # 8*8
        self.residual_block6 = ResidualBlock(512, 512)  # 8*8
        self.mpool2 = nn.Sequential(
            nn.BatchNorm2d(512),
            nn.ReLU(inplace=True),
