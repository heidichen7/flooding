...
def load_data(presaved=True):
    ...
    train_set = FloodDataset(flooding_const.TRAIN_CSV_PATH, flooding_const.TRAIN_PATH, data_transforms['train'])
    val_set = FloodDataset(flooding_const.VAL_CSV_PATH, flooding_const.VAL_PATH, data_transforms['val'])
    test_set = FloodDataset(flooding_const.TEST_CSV_PATH, flooding_const.TEST_PATH, data_transforms['test'])
